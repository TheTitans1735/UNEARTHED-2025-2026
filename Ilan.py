...
async def unearth2():
    ...
    await multitask(
        ...
        ilan.motor_back.run_until_stalled(200, duty_limit=50)
    )
    debug=False
    await ilan.turn(90,350)
    await ilan.turn(-15,370)
    await multitask( ilan.run_front_motor(200,100), ilan.turn(12))
    await wait(200)
    await ilan.run_front_motor(100,-95)
    await ilan.drive_until_button(500)
    await ilan.run_front_motor_fast(70, 1)
    await ilan.drive_straight(-5,1000)
    await multitask(ilan.turn_without_right_wheel(-120,450), ilan.motor_back.run_time(-200, 2200))
    await ilan.wfb(debug)
    await ilan.drive_straight(-12,450)
    await ilan.wfb(debug)
    await ilan.run_back_motor(200,-150)
    await ilan.wfb(debug)
    await ilan.drive_straight(-13,450,gradual_stop=False)
    await ilan.wfb(debug)
    # await ilan.motor_back.run_until_stalled(200)
    await ilan.run_back_motor(350,150)
    await multitask(
        ilan.run_back_motor(350,150),
        ilan.motor_front.run_time(300,1.),
        ilan.drive_straight(7,300,False,False,False)
    )
...
async def ritsatMaavar_dup():
    ...
    await ilan.run_front_motor(700,283)
    # await ilan.wfb()
    for _ in range(3):
        await ilan.turn(-30,120)
        await ilan.run_front_motor(700, -50)
        await ilan.turn(26,180)
        await ilan.run_front_motor(700, 50)
