...
async def skeleton():
    ...
    await multitask (ilan.run_front_motor(300, -110), ilan.drive_straight(2,300))
...
async def cave():
    ...
    await ilan.wait_for_button(debug)
    await ilan.motor_back.run_time(1000, 3000)
    await ilan.wait_for_button(debug)
    await ilan.drive_straight(8.5, 75)
    ...
    await ilan.wait_for_button(debug)
    await ilan.drive_straight(-13, 125)
    await ilan.wait_for_button(debug)
...
async def ship():
    await ilan.drive_straight(65.5, 500)
